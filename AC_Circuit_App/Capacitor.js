class Capacitor extends CapacitiveReactance(
  ...
  drawDetails() {
    ...
    if (this.rotate == 2) {
      ...
      if (this.probe) {
        ...
        if (this.selected == this.v) {
          ...
          this.vVoltageToGroundLabel.yOffset = -60;
          this.vVoltageToGroundLabel.draw();
        }
      }
    }
    ...
    if (this.rotate == 4) {
      ...
      if (this.probe) {
        if (this.selected == this.u) {
          this.uVoltageToGroundLabel.xOffset = 60;
          this.uVoltageToGroundLabel.yOffset = -60;
          this.uVoltageToGroundLabel.draw();
        }
        if (this.selected == this.v) {
          this.vVoltageToGroundLabel.xOffset = -60;
