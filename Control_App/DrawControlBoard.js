function drawControlBoard() {
  ...
  for (let button of jogButtons) {
    button.display();
  }
  for (let selector of selectorSwitches) {
    selector.display();
  }
  for (let thermalOverLoad of thermalOverLoads) {
    thermalOverLoad.display();
  }
